​
title:: "Getting Started with SRE - Training"
source:: "https://learn.microsoft.com/en-us/training/modules/intro-to-site-reliability-engineering/6-getting-started"
author:: [[Orin-Thomas]]
published::
created:: 2026-06-11
description:: "Getting started with SRE"
tags:: clippings
...
1. [*Site Reliability Engineering: How Google Runs Production Systems*](https://www.oreilly.com/library/view/site-reliability-engineering/9781491929117/) (known as "The SRE Book")
2. [*The Site Reliability Workbook: Practical Ways to Implement SRE*](https://www.oreilly.com/library/view/the-site-reliability/9781492029496/) (known as "The SRE Workbook")
3. [*Seeking SRE: Conversations About Running Production Systems at Scale*](https://www.oreilly.com/library/view/seeking-sre/9781491978856/)
4. [*Implementing Service Level Objectives*](https://www.oreilly.com/library/view/implementing-service-level/9781492076803/) by Alex Hidalgo — a focused, modern treatment of the SLI, SLO, and error budget material introduced earlier in this module.

(As a quick disclosure, the primary author of this module is the curator/editor of *Seeking SRE*.)
...
- The [Manage site reliability](https://learn.microsoft.com/en-us/training/modules/manage-site-reliability/) module, part of the [Develop a Site Reliability Engineering (SRE) strategy](https://learn.microsoft.com/en-us/training/paths/az-400-develop-sre-strategy/) learning path, which goes deeper into operational ownership, monitoring with Azure Monitor Application Insights, and blameless postmortems.
- The [Reliability pillar](https://learn.microsoft.com/en-us/azure/well-architected/reliability/) of the Azure Well-Architected Framework, which maps SRE-style reliability practices onto Azure workloads.
