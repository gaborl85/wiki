​
title:: "What Is SRE and Why Does It Matter? - Training"
source:: "https://learn.microsoft.com/en-us/training/modules/intro-to-site-reliability-engineering/2-what-is-sre-and-why-does-it-matter"
author:: [[Orin-Thomas]]
published::
created:: 2026-06-11
description:: "What is SRE and why does it matter?"
tags:: clippings
The best place to start is often the beginning. Let’s start by just asking the basic question "What is Site Reliability Engineering?" There are many answers to this question floating around, including [the one often quoted](https://sre.google/sre-book/introduction/) by the person who coined the term (Ben Treynor Sloss at Google), but the most practical answer we can offer is:
...
![A blank screenshot representing a PHP app that fails to load.](https://learn.microsoft.com/en-us/training/advocates/intro-to-site-reliability-engineering/media/02_blank-screenshot.png)
...
![A screenshot of a failed Java app with an HTTP Status 500 error.](https://learn.microsoft.com/en-us/training/advocates/intro-to-site-reliability-engineering/media/02_java-screenshot.png)
