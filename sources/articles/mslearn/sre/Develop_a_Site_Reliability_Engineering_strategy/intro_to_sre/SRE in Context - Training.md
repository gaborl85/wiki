​
title:: "SRE in Context - Training"
source:: "https://learn.microsoft.com/en-us/training/modules/intro-to-site-reliability-engineering/3-sre-in-context"
author:: [[Orin-Thomas]]
published::
created:: 2026-06-11
description:: "SRE in context"
tags:: clippings
...
For lots of good information about DevOps, see the [DevOps resource center](https://learn.microsoft.com/en-us/devops/).
...
- SRE is commonly used as a job title — someone is "an SRE". DevOps is primarily a cultural movement and set of practices; although "DevOps engineer" has become a common job title in the industry (and Microsoft offers a [DevOps Engineer Expert certification](https://learn.microsoft.com/en-us/credentials/certifications/devops-engineer/)), the core idea of DevOps describes how teams work together rather than a single role.
...
Given the origin of SRE, which discipline has had the most impact on it?
...
DevOps came first as a named movement.

Google SRE started earlier, but both emerged in the 2000s as parallel responses to similar challenges.

They began at exactly the same time.

3.

Is SRE the next evolutionary step from DevOps?
...
What are two best practices that are central to both DevOps and SRE?
